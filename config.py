...
LLM_MODEL = _env("LLM_MODEL", "google/gemini-2.5-flash")
...
LLM_RETRY_ATTEMPTS = int(_env("LLM_RETRY_ATTEMPTS", "1"))
LLM_RETRY_BACKOFF_BASE = float(_env("LLM_RETRY_BACKOFF_BASE", "2.0"))
